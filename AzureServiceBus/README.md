...
- [Azure SQLEdge](https://mcr.microsoft.com/v2/azure-sql-edge/tags/list)

### [Docker compose file](/AzureServiceBus/docker-compose.yml)

### References
- [Images Tags](https://mcr.microsoft.com/en-us/artifact/mar/azure-messaging/servicebus-emulator/tags)
